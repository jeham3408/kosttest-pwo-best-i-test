    ...
    <>
            ...
            <section className="hero-section">
              ...
              <div className="hero-board" aria-label="Topp produkter">
                {testedProducts.slice(0, 2).map((product) => (
                  <a className="hero-product" href={`/pwo/${product.id}/`} onClick={(e) => { e.preventDefault(); setSelectedProduct(product.id); setPage('product') }} key={product.id}>
                ...
                {testedProteinProducts.slice(0, 1).map((product) => (
                  <a className="hero-product" href={`/protein/${product.id}/`} onClick={(e) => { e.preventDefault(); setSelectedProduct(product.id); setPage('protein-product') }} key={product.id}>
        ...
        {page === 'protein-metode' && (
          <section className="content-section">
            ...
            <div className="section-heading" style={{ marginBottom: 8 }}>
              <span>Metode</span>
              <h1>Slik scorer vi proteinpulver</h1>
              <p className="section-intro">DIAAS (70 %) + pris per g protein (30 %). IAAS vises for sammenligning av aminosyreprofil.</p>
            </div>
            <ProteinMetodeSection />
          </section>
        )}
      ...
      <footer className="site-footer">
        <nav aria-label="Bunnnavigasjon" className="footer-nav">
          ...
          <a href="/tester/protein/" onClick={(e) => { e.preventDefault(); setPage('lb-protein'); setSelectedProduct(null) }}>Protein</a>
        ...
        <p className="footer-meta">Oppdatert {lastUpdated} · Ærlig PWO- og proteinrangering for Norge</p>
      </footer>
    </>
  )
}
