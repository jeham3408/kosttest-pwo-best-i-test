...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    sourceLabel: 'Whey protein concentrate (96 %)',
    keyFeatures: ['72 % protein (sjokolade)', 'Ofte på tilbud', '40+ smaker', '22 g protein/dose'],
    verdict: 'Impact Whey er prisvinneren på kampanje — ekstremt lav kr/g protein, men smaksvarianter som sjokolade har lavere protein% (72 g/100 g) enn markedsføringen antyder.',
    strengths: ['Svært lav pris på tilbud (169 kr/1 kg)', 'God whey-concentrate IAAS-profil', 'Stort smaksutvalg'],
    watchouts: ['Inneholder laktose (whey concentrate)', 'Protein% varierer 72–82 % etter smak', 'Levering fra UK + toll/VAT', 'Melke- og soyaallergen'],
    url: 'https://www.myprotein.no/p/sports-nutrition-nc/myprotein-impact-whey-protein-chocolate-1kg/11068071/',
    image: '/images/protein/myprotein-impact-whey.jpg',
  },
  {
