...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    keyFeatures: ['84% protein (sjokolade)', 'Whey isolate', 'Lavt laktoseinnhold', '31 g protein/dose'],
    verdict: 'Star Nutrition Whey-100 er et nordisk whey isolate med opptil 87 % protein og lavt laktoseinnhold. Sterk protein% og god løselighet, men dyrere enn Whey-80 og inneholder fortsatt melk/laktose-allergener.',
    strengths: ['Høy protein% (isolate)', 'Lavt laktoseinnhold', 'Nordisk merke med bred smakspalette'],
    watchouts: ['Dyrere enn Whey-80 (549 kr/kg)', 'Inneholder laktose — ikke helt laktosefri', 'Melke- og soyaallergen', 'Inneholder aspartam'],
