...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    verdict: 'Star Nutrition Whey-100 er et nordisk whey isolate med 84 % protein og lavt laktoseinnhold. Sterk DIAAS-estimat og god dose — men høyere pris enn Whey-80 og inneholder aspartam i mange smaker.',
    strengths: ['Høy protein% (isolate)', 'Lavt laktoseinnhold', 'Nordisk merke med bred tilgjengelighet', '31 g protein per dose'],
    watchouts: ['Ikke helt laktosefritt', 'Aspartam i smaksvarianter', 'Dyrere enn Whey-80 (549 kr/kg)', 'Melke- og soyaallergen'],
