...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    verdict: 'Bodylab Whey 100 er en ekte bestselger på bodylab.no — whey-blend (isolat + konsentrat) med 70 g protein per 100 g (Ultimate Chocolate). Danskprodusert med god smak, men inneholder laktose fra konsentratet og er ikke laktosefritt.',
    strengths: ['Pålitelig merke', 'Protein fra fersk melk', 'Ingen aspartam', 'Danskprodusert'],
    watchouts: ['Inneholder laktose (whey concentrate)', 'Melke- og soyaallergen', 'Lavere protein% enn rene isolates', 'Kun på bodylab.no'],
