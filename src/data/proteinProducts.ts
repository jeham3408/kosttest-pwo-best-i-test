...
const rawProducts: RawProtein[] = [
  {
    ...
    keyFeatures: ['78% protein', 'Hydrolysert isolate', 'Laktosefattig', '25 g protein/dose'],
    verdict: 'Dymatize ISO100 er et hydrolysert whey isolate der laktose og fett er skilt ut. Sterk DIAAS-estimat og rask opptak — men dyr per kg og inneholder melk/soya-allergener.',
  ...
  },
  {
    ...
    sourceLabel: 'Whey isolate + concentrate + hydrolysert',
    keyFeatures: ['24 g protein/dose', 'Whey-blend (isolat + konsentrat)', 'Bred smakspalette'],
    verdict: 'Gold Standard er referanseproduktet for whey i Norge — whey-blend med isolat, konsentrat og hydrolyserte peptider. God balanse mellom kvalitet og pris, men inneholder laktose fra konsentratet.',
  ...
  },
  {
    ...
    keyFeatures: ['70 % protein (Ultimate Chocolate)', 'Danskprodusert', '0 g tilsatt sukker', '23 g protein/dose'],
    verdict: 'Bodylab Whey 100 er bestselgeren på bodylab.no — whey-blend (isolat + konsentrat) med 70 % protein per 100 g. God smak og dansk produksjon, men inneholder laktose og er ikke for de med melkeallergi.',
    strengths: ['Konkurransedyktig pris (297 kr kampanje)', 'Protein fra fersk melk', 'Ingen aspartam', 'Danskprodusert'],
    watchouts: ['Inneholder laktose (whey konsentrat)', 'Melke- og soyaallergen', 'Lavere protein% enn mange isolates', 'Kun på bodylab.no'],
    url: 'https://www.bodylab.no/shop/bodylab-whey-100-663p.html',
    image: '/images/protein/bodylab-whey-100.jpg',
    lactoseFree: false,
    caloriesPer100g: 387,
    allergenNote: 'Melkeprotein (konsentrat + isolat), soya- og solsikkelecitin. Inneholder laktose.',
  },
  {
    id: 'star-whey-100',
    ...
    servings: 27,
    proteinPer100g: 84,
    proteinPerServingG: 31,
    leucinePerServingG: null,
    sourceType: 'whey-isolate',
    sourceLabel: '100 % myseproteinisolat',
    keyFeatures: ['84 % protein (sjokolade)', '100 % whey isolate', 'Lavt fett og laktose', '31 g protein/dose'],
    verdict: 'Star Nutrition Whey-100 er et nordisk whey isolate med svært høyt proteininnhold (84 g/100 g) og lavt fett/karbohydrat. Sterk kvalitet fra Carbery, men ikke helt laktosefritt.',
