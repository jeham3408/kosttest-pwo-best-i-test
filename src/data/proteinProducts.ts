...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    keyFeatures: ['84 % protein (sjokolade)', '100 % myseproteinisolat', 'Lavt fett og laktose', '31 g protein/dose'],
    verdict: 'Star Nutrition Whey-100 er et rent whey isolate med 84 % protein og lavt laktoseinnhold. Sterk DIAAS-estimat og god dosestørrelse — men høyere pris enn opprinnelig antatt i repo.',
    strengths: ['Høy protein% (84 g/100 g)', '100 % whey isolate', 'Lavt laktoseinnhold', 'Nøttefri (garantert)'],
    watchouts: ['Ikke helt laktosefritt', 'Inneholder aspartam', 'Melke- og soyaallergen', 'Protein% varierer 79–87 % etter smak'],
