...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    keyFeatures: ['84% protein', 'Nordisk merke', 'Lavt fett og laktose'],
    verdict: 'Star Nutrition Whey-100 er et rent myseproteinisolat med høy protein% og god tilgjengelighet hos Gymgrossisten — et solid nordisk alternativ til importmerker.',
    strengths: ['Høy protein% (84 %)', 'Nordisk merke', 'Lavt fett og karbohydrater', 'God tilgjengelighet'],
    watchouts: ['Ikke laktosefritt — lavt, men ikke null', 'Dyrere enn Whey-80', 'Inneholder aspartam i smaksvarianter', 'Melke- og soyaallergen'],
