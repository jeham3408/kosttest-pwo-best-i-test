...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    keyFeatures: ['84 % protein (sjokolade)', '100 % whey isolate', 'Lav laktose', 'Nordisk merke'],
    verdict: 'Star Nutrition Whey-100 er Gymgrossistens eget premium-isolat — 100 % myseproteinisolat fra Carbery med opptil 87 % protein. Sterk DIAAS-estimat og lav laktose, men ikke laktosefritt.',
    strengths: ['Høy protein% for isolate', 'Lav laktose (filtrert)', 'Toppselger på Gymgrossisten', 'Nøttefri'],
    watchouts: ['Ikke helt laktosefritt', 'Inneholder aspartam', 'Høyere pris enn repo antok (549 kr)', 'Melke- og soyaallergen'],
