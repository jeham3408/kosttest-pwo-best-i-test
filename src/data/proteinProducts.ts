...
const rawProducts: RawProtein[] = [
  {
    ...
    keyFeatures: ['78 % protein (etikett)', 'Hydrolysert isolate', '25 g protein/dose', 'Svært laktosefattig'],
    verdict: 'Dymatize ISO100 er et hydrolysert whey-isolat med 25 g protein per 32 g dose og laktose filtrert bort. Sterk DIAAS-profil, men høyere pris per kg enn mange blends.',
    strengths: ['Hydrolysert for rask absorpsjon', 'Laktose og fett filtrert bort', 'Svært lavt fettinnhold'],
    watchouts: ['Høyere pris (899 kr/932 g)', 'Inneholder melk og soya', 'Protein% lavere enn opprinnelig antatt (78 %, ikke 86 %)'],
    url: 'https://www.gymgrossisten.no/iso-100-myseproteinisolat-932-g/9922-098R.html',
    image: 'https://www.gymgrossisten.no/dw/image/v2/BDJH_PRD/on/demandware.static/-/Sites-hsng-master-catalog/default/dwa5482365/media/GG-Produktbilder/Dymatize/9922-098_Naskor_Iso-100-932-g-Gourmet-Chocolate_1122.jpg?sw=655&sh=655&sm=fit&sfrm=png',
  },
  {
