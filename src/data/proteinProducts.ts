...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    verdict: 'Bodylab Whey 100 er en ekte bestselger på bodylab.no — danskprodusert whey-blend med 70 % protein per 100 g. God smak og pålitelig merke, men inneholder laktose fra konsentratet og er ikke like proteinrik som rene isolater.',
    strengths: ['Pålitelig nordisk merke', 'Danskprodusert fra fersk melk', 'Ingen aspartam eller AZO-farger'],
    watchouts: ['Inneholder laktose (whey concentrate)', 'Lavere protein% (70 %) enn mange isolates', 'Melke- og soyaallergen', 'Solges kun på bodylab.no'],
