...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    sourceLabel: '100% whey protein isolate',
    keyFeatures: ['84 % protein (sjokolade)', '100 % whey isolate', '31 g protein/dose', 'Lavt laktoseinnhold'],
    verdict: 'Star Nutrition Whey-100 er et nordisk whey isolate med 84 % protein og 31 g protein per dose — langt bedre enn opprinnelig concentrate-data i repo. Sterk DIAAS-estimat, men prisen (549 kr/kg) er høyere enn antatt.',
    strengths: ['Høy protein% (84 %)', 'Ren whey isolate', '31 g protein per dose', 'Lavt laktoseinnhold'],
    watchouts: ['Ikke laktosefritt — uegnet ved alvorlig intoleranse', 'Høyere pris enn repo antok (549 kr)', 'Inneholder aspartam og soya (lecitin)', 'Protein% varierer 79–87 % etter smak'],
