...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    keyFeatures: ['84 % protein (sjokolade)', '100 % myseisolat', 'Lavt laktoseinnhold', 'Carbery-protein'],
    verdict: 'Star Nutrition Whey-100 er et nordisk myseisolat med opptil 87 % protein per 100 g — langt bedre enn opprinnelig «concentrate»-data. Solid valg for høy protein% og raskt opptak, men inneholder laktose og aspartam.',
    strengths: ['Høyt proteininnhold (84–87 %)', 'Nordisk merke', 'Lavt fett og karbohydrater', 'God tilgjengelighet på GG'],
    watchouts: ['Inneholder laktose (lavt, ikke laktosefritt)', 'Aspartam i de fleste smaker', 'Melke-, soya- og fenylalaninallergen'],
