...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    verdict: 'Bodylab Whey 100 er en ekte bestselger på bodylab.no — whey-blend med 70 % protein per 100 g (Ultimate Chocolate). Danskprodusert med protein fra fersk melk, men inneholder laktose fra konsentrat-delen.',
    strengths: ['Pålitelig merke', 'Protein fra fersk melk', 'Ingen aspartam', 'Ingen amino-spiking'],
    watchouts: ['Inneholder laktose (whey concentrate)', 'Lavere protein% enn mange isolates', 'Melke- og soyaallergen', 'Kampanjepris varierer'],
