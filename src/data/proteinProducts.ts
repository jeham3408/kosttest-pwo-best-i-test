...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    verdict: 'Bodylab Whey 100 er en ekte bestselger på bodylab.no — whey-blend med 70 % protein per 100 g (Ultimate Chocolate). Danskprodusert med protein fra fersk melk, men inneholder laktose fra whey-konsentrat.',
    strengths: ['Pålitelig nordisk merke', 'Protein fra fersk melk', 'Ingen aspartam eller amino-spiking'],
    watchouts: ['Inneholder laktose (whey concentrate)', 'Solges kun på bodylab.no', 'Melke- og soyaallergen (lecitin)'],
