...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    verdict: 'Bodylab Whey 100 er bestselgeren på bodylab.no — danskprodusert whey-blend (isolat + konsentrat) med 70 % protein per 100 g (Ultimate Chocolate). God smak og rimelig pris per kg, men inneholder laktose fra konsentratet og er ikke like proteinrik som rene isolater.',
    strengths: ['Pålitelig merke', 'Protein fra fersk melk', 'Ingen aspartam', 'Kampanjepris ofte lav'],
    watchouts: ['Inneholder laktose (whey concentrate)', 'Melke- og soyaallergen', 'Lavere protein% enn mange isolater'],
