...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    keyFeatures: ['70 g protein/100 g (Ultimate Chocolate)', 'Danskprodusert', '0 g tilsatt sukker'],
    verdict: 'Bodylab Whey 100 er en ekte bestselger på bodylab.no — whey-blend (konsentrat + isolat) med 70 g protein per 100 g. God smak og tilgjengelighet, men inneholder laktose fra konsentratet og lavere protein% enn rene isolater.',
    strengths: ['Pålitelig nordisk merke', 'Protein fra fersk kumelk', 'Ingen aspartam eller AZO-farger'],
    watchouts: ['Inneholder laktose (whey concentrate)', 'Lavere protein% enn isolater', 'Melke- og soyaallergen'],
    url: 'https://www.bodylab.no/whey-100-1-kg',
