...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    sourceLabel: 'Whey isolate (100%)',
    keyFeatures: ['84 % protein (sjokolade)', '100 % whey isolate', 'Lavt laktoseinnhold', 'Nordisk merke'],
    verdict: 'Star Nutrition Whey-100 er et svensk/nordisk toppselger-protein med 100 % whey isolate fra Carbery. Høy protein% og lavt laktoseinnhold — men dyrere enn mange concentrates.',
    strengths: ['Høy protein% (84 g/100 g)', 'Whey isolate — ikke concentrate', 'Lavt laktoseinnhold', 'Populært nordisk merke'],
    watchouts: ['Inneholder laktose (lavt, ikke fritt)', '549 kr — dyrere enn mange alternativer', 'Soya-allergen (lecitin)', 'Protein% varierer 79–87 % etter smak'],
