...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    verdict: 'Bodylab Whey 100 er en ekte bestselger på bodylab.no — whey-blend (87 % myseprotein) med 70 g protein per 100 g. God smak og tilgjengelighet, men lavere protein% og høyere pris per g protein enn mange konkurrenter.',
    strengths: ['Pålitelig nordisk merke', 'Protein fra fersk melk', 'Bred smakspalett'],
    watchouts: ['Inneholder laktose (whey concentrate)', 'Lavere protein% enn isolates', 'Melke- og soyaallergen'],
