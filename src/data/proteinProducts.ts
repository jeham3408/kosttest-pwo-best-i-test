...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    sourceLabel: '100% whey isolate',
    keyFeatures: ['84 % protein (etikett)', '100 % myseisolat', 'Lav laktose', 'Norsk merke'],
    verdict: 'Star Nutrition Whey-100 er et rent whey isolate fra Carbery med 82–87 % protein per 100 g avhengig av smak. Sterk DIAAS-estimat og lavt laktoseinnhold — men ikke laktosefritt, og prisen er høyere enn opprinnelig antatt.',
    strengths: ['Norsk merke med god tilgjengelighet', 'Høy protein% (whey isolate)', 'Lavt fett og laktose'],
    watchouts: ['Ikke laktosefritt — melkeallergen', 'Inneholder soya (lecitin) og aspartam', 'Protein% varierer 79–87 % etter smak'],
    url: 'https://www.gymgrossisten.no/whey-100-1-kg-cookies-and-cream/5791.html',
