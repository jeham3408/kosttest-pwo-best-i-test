...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    keyFeatures: ['84 % protein/100 g', '100 % whey isolate (Carbery)', 'Lavt fett og laktose'],
    verdict: 'Star Nutrition Whey-100 er et solid nordisk isolate med høy protein% og lavt laktoseinnhold. God kvalitet fra Carbery, men prisen (549 kr/kg) er høyere enn mange concentrate-alternativer.',
    strengths: ['Høy protein% for isolate', 'Nordisk merke med bred tilgjengelighet', 'Lavt fett og laktose'],
    watchouts: ['Ikke helt laktosefritt — uegnet ved alvorlig intoleranse', 'Inneholder aspartam (fenylalanin)', 'Protein% varierer 79–87 % etter smak'],
