...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    keyFeatures: ['84 % protein (sjokolade)', '100 % whey isolate', 'Lavt laktoseinnhold', 'Norsk merke'],
    verdict: 'Star Nutrition Whey-100 er et premium whey isolate fra Carbery med 84 % protein per 100 g (sjokolade). Høy renhet og god DIAAS-profil, men høyere pris enn opprinnelig antatt i repo.',
    strengths: ['Høy protein% for isolate', 'Norsk merke med god tilgjengelighet', 'Lavt fett og laktose', 'Raskt opptak'],
    watchouts: ['Ikke helt laktosefritt — uegnet ved alvorlig laktoseintoleranse', 'Protein% varierer 79–87 % etter smak', 'Inneholder aspartam og melkeallergen'],
