...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    verdict: 'Bodylab Whey 100 er en ekte bestselger på bodylab.no — whey-blend med 70 % protein per 100 g (Ultimate Chocolate). Verifisert mot produsentens næringsdeklarasjon. Inneholder laktose fra konsentrat-delen.',
    strengths: ['Pålitelig merke', 'Protein fra fersk melk', 'Ingen aspartam', 'Ingen amino spiking'],
    watchouts: ['Inneholder laktose (whey concentrate)', 'Lavere protein% enn rene isolates', 'Melke- og soyaallergen', 'Solges kun på bodylab.no'],
