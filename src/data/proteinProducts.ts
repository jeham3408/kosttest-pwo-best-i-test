...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    verdict: 'Star Nutrition Whey-100 er et nordisk whey isolate med høy protein% og lavt fett/laktose. God kvalitet fra Carbery, men dyrere enn Whey-80 og ikke helt laktosefritt.',
    strengths: ['Høy protein% (82–87 % etter smak)', '100 % whey isolate', 'Nordisk merke med bred tilgjengelighet'],
    watchouts: ['Inneholder laktose — ikke for alvorlig intoleranse', 'Dyrere enn Whey-80 (549 kr/kg)', 'Melke- og soyaallergen'],
