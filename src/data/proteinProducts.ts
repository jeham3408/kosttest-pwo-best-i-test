...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    verdict: 'Bodylab Whey 100 er en ekte bestselger på bodylab.no — whey-blend (87 % melkeprotein) med 70 % protein per 100 g (Ultimate Chocolate). God smak og dansk produksjon, men inneholder laktose fra whey-konsentratet.',
    strengths: ['Pålitelig merke', 'Protein fra fersk melk', 'Ingen aspartam', 'Ingen aminospiking'],
    watchouts: ['Inneholder laktose (whey concentrate)', 'Melke- og soyaallergen', 'Lavere protein% enn mange isolates', 'Kampanjepris varierer på bodylab.no'],
