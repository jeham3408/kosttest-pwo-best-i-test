...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    keyFeatures: ['84 % protein (sjokolade)', '100 % myseisolat', 'Lavt laktoseinnhold'],
    verdict: 'Star Nutrition Whey-100 er et nordisk whey-isolat med 84 % protein per 100 g og lavt laktoseinnhold. Verifisert mot Gymgrossisten — høyere pris enn opprinnelig i repo, men bedre proteinprofil enn antatt.',
    strengths: ['Høy protein% for isolate', 'Nordisk merke (Carbery-kilde)', 'Lavt fett og laktose'],
    watchouts: ['Inneholder laktose — ikke laktosefritt', 'Aspartam i smaksvarianter', 'Høyere pris enn opprinnelig data (549 kr)'],
