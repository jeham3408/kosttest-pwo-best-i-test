...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    verdict: 'Bodylab Whey 100 er en ekte bestselger på bodylab.no — whey-blend med 70 % protein per 100 g (Ultimate Chocolate). Sterk smak og dansk produksjon, men inneholder laktose fra whey-konsentratet.',
    strengths: ['Pålitelig merke', 'Protein fra fersk melk', 'Ingen aspartam', 'God pris ved kampanje'],
    watchouts: ['Inneholder laktose (whey concentrate)', 'Melke- og soyaallergen', 'Lavere protein% enn mange isolates'],
