...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    sourceLabel: '100 % whey isolate (Carbery)',
    keyFeatures: ['84 % protein (sjokolade)', '100 % whey isolate', 'Lavt laktoseinnhold', '31 g protein/dose'],
    verdict: 'Star Nutrition Whey-100 er et nordisk whey isolate fra Carbery med opptil 84–87 % protein per 100 g. Høy kvalitet og bred tilgjengelighet på Gymgrossisten — men prisen (549 kr/kg) er høyere enn mange concentrates.',
    strengths: ['Nordisk merke (Star Nutrition)', '100 % whey isolate', 'Høy protein% (opptil 87 %)', 'Lavt laktoseinnhold'],
    watchouts: ['549 kr/kg — ikke blant billigste', 'Inneholder laktose — ikke helt laktosefritt', 'Aspartam og soya (lecitin)', 'Protein% varierer 79–87 % etter smak'],
