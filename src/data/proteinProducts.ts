...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    verdict: 'Star Nutrition Whey-100 er et nordisk whey isolate med høy protein% og lavt fett/laktose — men dyrere enn repo antok (549 kr). God kvalitet fra Carbery, men inneholder laktose og aspartam i smaksvarianter.',
    strengths: ['100% whey isolate', 'Høy protein% (79–87 %)', 'Nordisk merke', 'Lavt fett og karbohydrater'],
    watchouts: ['Ikke laktosefritt — uegnet ved alvorlig intoleranse', 'Inneholder aspartam', 'Dyrere enn antatt (549 kr)'],
