...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    verdict: 'Bodylab Whey 100 er en ekte bestselger på bodylab.no — whey-blend med 70 % protein per 100 g (Ultimate Chocolate). Danskprodusert med protein fra fersk melk. Sterk smak og god pris ved kampanje, men inneholder laktose fra konsentrat-delen.',
    strengths: ['Pålitelig nordisk merke', 'Protein fra fersk melk', 'Ingen aspartam', 'Konkurransedyktig kampanjepris'],
    watchouts: ['Inneholder laktose (whey concentrate)', 'Solges kun på bodylab.no', 'Lavere protein% enn mange isolates', 'Melke- og soyaallergen'],
