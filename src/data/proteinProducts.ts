...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    keyFeatures: ['84 % protein (sjokolade)', 'Whey isolate', 'Lav laktose', '27 porsjoner'],
    verdict: 'Star Nutrition Whey-100 er et nordisk toppselger-isolat med opptil 87 % protein per 100 g og lav laktose. Verifisert mot Gymgrossisten — ikke å forveksle med billigere Whey-80 konsentrat.',
    strengths: ['Høy protein% (isolate)', 'Lav laktose — ofte tålt av laktoseintolerante', 'Nordisk merke med mange smaker', 'God løselighet'],
    watchouts: ['Ikke helt laktosefri — unngå ved alvorlig intoleranse', 'Inneholder aspartam og soya', 'Høyere pris enn Whey-80 (549 kr/kg)'],
