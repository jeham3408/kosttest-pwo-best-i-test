...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    sourceLabel: 'Myseproteinisolat (100 %)',
    keyFeatures: ['84 % protein (sjokolade)', '100 % whey isolate', 'Lavt laktoseinnhold', '31 g protein/dose'],
    verdict: 'Star Nutrition Whey-100 er et rent whey isolate fra Carbery med opptil 87 % protein per 100 g. Sterk DIAAS-estimat og lavt laktoseinnhold, men ikke laktosefritt — og prisen er høyere enn opprinnelig antatt.',
    strengths: ['100 % whey isolate', 'Høy protein% (79–87 % etter smak)', 'Lavt laktoseinnhold', 'Nøttefri (garantert)'],
    watchouts: ['Ikke laktosefritt — uegnet ved alvorlig intoleranse', 'Inneholder aspartam (fenylalanin)', 'Høyere pris enn tidligere data (549 kr)'],
