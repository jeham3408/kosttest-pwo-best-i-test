...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    keyFeatures: ['70 % protein (Ultimate Chocolate)', 'Danskprodusert', '0 g tilsatt sukker'],
    verdict: 'Bodylab Whey 100 er en ekte bestselger på bodylab.no — whey-blend (isolat + konsentrat) med 70 % protein per 100 g. Danskprodusert med god smak, men inneholder laktose fra konsentratet og er ikke laktosefritt.',
    strengths: ['Pålitelig merke', 'Protein fra fersk melk', 'Ingen aspartam', 'Ingen amino-spiking'],
    watchouts: ['Inneholder laktose (whey concentrate)', 'Melke- og soyaallergen', 'Lavere protein% enn mange isolates', 'Kun på bodylab.no'],
