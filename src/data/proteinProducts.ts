...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    keyFeatures: ['84% protein', 'Whey isolate', 'Lavt laktose', '31 g protein/dose'],
    verdict: 'Star Nutrition Whey-100 er et nordisk whey isolate med svært høy protein% og lavt fett/laktose. Sterk DIAAS-estimat, men dyrere enn Whey-80 og inneholder aspartam i smaksvarianter.',
    strengths: ['Høy protein% (84 g/100 g)', 'Whey isolate — lavt laktose', 'Raskt opptak', 'Nordisk merke med bred tilgjengelighet'],
    watchouts: ['Dyrere enn Whey-80 (549 kr/kg)', 'Inneholder laktose (lav mengde)', 'Aspartam i smaksvarianter', 'Soya-lecitin som emulgator'],
