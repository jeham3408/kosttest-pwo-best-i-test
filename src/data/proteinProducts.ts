...
const rawProducts: RawProtein[] = [
  {
    ...
    keyFeatures: ['78 % protein (etikett)', 'Hydrolysert isolate', '25 g protein/dose', 'Laktosefattig'],
    verdict: 'Dymatize ISO100 er et hydrolysert whey isolate med 25 g protein per 32 g dose (~78 % per 100 g på NO-etikett). Sterk DIAAS-estimat og svært lavt fett/karbo, men premiumpris.',
    strengths: ['Hydrolysert for rask absorpsjon', 'Laktosefattig isolate', 'Sterk DIAAS-estimat (hydrolyzed-whey)'],
    watchouts: ['899 kr for 932 g — dyr per g protein', 'Inneholder melk og soya', 'Etikett viser noe karbo/fett til tross for «karbofri»-markedsføring'],
    url: 'https://www.gymgrossisten.no/iso-100-myseproteinisolat-932-g/9922-098R.html',
    image: 'https://www.gymgrossisten.no/dw/image/v2/BDJH_PRD/on/demandware.static/-/Sites-hsng-master-catalog/default/dwa5482365/media/GG-Produktbilder/Dymatize/9922-098_Naskor_Iso-100-932-g-Gourmet-Chocolate_1122.jpg',
  },
  {
