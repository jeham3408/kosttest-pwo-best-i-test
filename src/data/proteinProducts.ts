...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    sourceLabel: 'Whey isolate (100% myseproteinisolat)',
    keyFeatures: ['84–87 % protein', '100 % whey isolate', 'Lavt laktoseinnhold', '31 g protein/dose'],
    verdict: 'Star Nutrition Whey-100 er et norsk whey isolate med høy protein% og lavt fett/laktose. God DIAAS-estimat og raskt opptak — men inneholder fortsatt melkeallergen og laktose i små mengder.',
    strengths: ['Høy protein% (84–87 %)', 'Whey isolate — ikke concentrate', 'Norsk merke med god tilgjengelighet'],
    watchouts: ['Inneholder laktose (lavt, men ikke laktosefri)', 'Aspartam i smaksvarianter', 'Melke- og soyaallergen'],
