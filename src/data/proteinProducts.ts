...
const rawProducts: RawProtein[] = [
  {
    ...
    keyFeatures: ['78 % protein (etikett)', 'Hydrolysert isolate', 'Laktosefattig', 'Inneholder melk og soya'],
    verdict: 'Dymatize ISO100 er et hydrolysert whey isolate med 25 g protein per 32 g porsjon (78 % per 100 g). Laktose er skilt ut i isolate-prosessen, men produktet inneholder fortsatt melk og soya (lecitin). Verifisert mot Gymgrossisten NO.',
    strengths: ['Hydrolysert for rask absorpsjon', 'Sterk DIAAS-estimat (whey isolate)', 'Laktosefattig — egnet for de fleste med laktoseintoleranse'],
    watchouts: ['Dyr (899 kr / 932 g)', 'Markedsføring sier «uten karbohydrater» — etikett viser 2,4 g karbohydrater/porsjon', 'Inneholder soya-lecitin'],
