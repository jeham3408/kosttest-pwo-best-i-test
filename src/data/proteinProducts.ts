...
const rawProducts: RawProtein[] = [
  {
    ...
    keyFeatures: ['78% protein', 'Hydrolysert', '2,7 g leucin/dose', 'Laktosefattig'],
    verdict: 'Dymatize ISO100 er hydrolysert whey isolate med høy leucin-tetthet og svært ren formel. Best for rask opptak etter trening, men dyrere per kg enn mange alternativer.',
    strengths: ['Sterk DIAAS-proxy (hydrolysert isolate)', 'Sterk leucinprofil', 'Hydrolysert for rask absorpsjon'],
    watchouts: ['Dyrere per kg enn concentrate', 'Lavere protein% enn oppgitt på noen import-etiketter'],
