...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    keyFeatures: ['84 % protein (sjokolade)', '100 % whey isolate', 'Lavt laktoseinnhold', '31 g protein/dose'],
    verdict: 'Star Nutrition Whey-100 er et nordisk whey isolate med høy protein% og lavt fett/laktose. Verifisert mot Gymgrossisten — ikke laktosefritt, men bedre egnet enn konsentrat for de fleste med laktoseintoleranse.',
    strengths: ['100 % myseproteinisolat', 'Høy protein% (84 g/100 g sjokolade)', 'Lavt fett og karbohydrater', 'Nordisk merke med bred smakspalette'],
    watchouts: ['Inneholder laktose (lavt nivå — ikke laktosefritt)', 'Melke- og soyaallergen', 'Aspartam i smaksvarianter', 'Dyrere enn Whey-80 (549 kr/kg)'],
