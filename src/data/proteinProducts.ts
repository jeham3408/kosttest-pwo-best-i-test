...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    verdict: 'Bodylab Whey 100 er en ekte bestselger på bodylab.no — whey-blend med 70 % protein per 100 g (Ultimate Chocolate). Danskprodusert med protein fra fersk melk, men lavere protein% enn rene isolater.',
    strengths: ['Pålitelig merke', 'Protein fra fersk melk', 'Ingen aspartam', 'God pris ved kampanje'],
