...
const rawProducts: RawProtein[] = [
  {
    ...
    keyFeatures: ['86% protein', 'Hydrolysert', '2,7 g leucin/dose', 'Laktosefattig'],
    verdict: 'Dymatize ISO100 topper med hydrolysert whey isolate, høy leucin-tetthet og svært ren formel. Best for rask opptak etter trening.',
    strengths: ['Høyest proteinrenhet i testen', 'Sterk leucinprofil', 'Hydrolysert for rask absorpsjon'],
    watchouts: ['Dyrere per kg enn concentrate', 'Smak kan være tynnere enn blend'],
    url: 'https://www.gymgrossisten.no/dymatize-iso100',
    image: IMG,
  },
  {
  ...
  },
  {
    ...
    url: 'https://www.proteinfabrikken.no',
    image: IMG,
  },
  {
    id: 'smartsupps-whey',
    ...
    url: 'https://www.gymgrossisten.no/smartsupps-100-whey',
    image: IMG,
  },
  {
  ...
  },
  {
    ...
    sourceType: 'whey-concentrate',
    sourceLabel: 'Whey concentrate',
    keyFeatures: ['Norsk merke', 'God pris', 'Enkel formel'],
    verdict: 'NutriTac Whey er et solid norsk alternativ med god balanse mellom pris og aminosyreprofil.',
    strengths: ['Norsk merke', 'God pris', 'Enkel formel'],
    watchouts: ['Concentrate — ikke topp renhet'],
    url: 'https://www.nutritac.no',
    image: IMG,
  },
  {
    id: 'peveo-whey',
    ...
    sourceType: 'whey-blend',
    sourceLabel: 'Whey isolate + concentrate',
    keyFeatures: ['Norsk merke', 'Peveo kvalitet', 'Balansert'],
    verdict: 'Peveo Whey er et norsk premium-alternativ med solid IAAS-profil og god smak.',
    strengths: ['Norsk merke', 'Balansert profil', 'God smak'],
    watchouts: ['Ikke billigste alternativ'],
    url: 'https://peveo.no',
    image: IMG,
  },
  {
