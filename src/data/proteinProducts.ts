...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    sourceLabel: 'Whey isolate (Carbery)',
    keyFeatures: ['84 % protein (sjokolade)', '100 % myseisolat', 'Lavt laktoseinnhold', '31 g protein/dose'],
    verdict: 'Star Nutrition Whey-100 er et svensk/nordisk whey isolate fra Carbery med 84 % protein per 100 g og lavt laktoseinnhold. Verifisert mot Gymgrossisten — høyere pris enn opprinnelig antatt, men bedre kvalitet enn concentrate.',
    strengths: ['100 % whey isolate (Carbery)', 'Høy protein% (82–87 % etter smak)', 'Lavt laktoseinnhold', 'God tilgjengelighet på GG'],
    watchouts: ['Inneholder laktose — ikke laktosefritt', 'Aspartam i de fleste smaker', 'Melke- og soyaallergen'],
