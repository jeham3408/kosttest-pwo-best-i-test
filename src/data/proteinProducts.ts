...
const rawProducts: RawProtein[] = [
  {
    ...
    keyFeatures: ['78 % protein (etikett)', 'Hydrolysert', 'Laktosefattig', '25 g protein/dose'],
    verdict: 'Dymatize ISO100 er hydrolysert whey isolate med rask absorpsjon og svært lavt laktoseinnhold. Verifisert mot Gymgrossisten: 25 g protein per 32 g porsjon (~78 % per 100 g). God etter trening, men dyr per kg.',
    strengths: ['Hydrolysert for rask opptak', 'Svært lavt laktoseinnhold', 'Ren isolate-formel', '25 g protein per dose'],
    watchouts: ['Dyr (899 kr/932 g)', 'Protein% lavere enn ofte markedsført', 'Inneholder melk og soya', 'Ofte utsolgt på GG'],
