...
const rawProducts: RawProtein[] = [
  ...
  },
  {
    ...
    keyFeatures: ['84 % protein', '100 % myseisolat', 'Carbery-protein', '31 g protein/dose'],
    verdict: 'Star Nutrition Whey-100 er et nordisk whey isolate med høy protein% og lavt fett/laktose. Solid kvalitet fra Carbery, men prisen er høyere enn opprinnelig antatt.',
    strengths: ['Høy protein% (84 g/100 g)', 'Nordisk merke med god tilgjengelighet', 'Lavt laktoseinnhold (isolat)', 'Carbery-protein'],
    watchouts: ['Inneholder laktose — ikke laktosefri', 'Aspartam i smaksvarianter', 'Melke- og soyaallergen', 'Protein% varierer 79–87 % etter smak'],
