...
const rawProducts: RawProtein[] = [
  {
    ...
    keyFeatures: ['78 % protein (etikett)', 'Hydrolysert isolate', 'Laktose skilt ut', 'Inneholder melk og soya'],
    verdict: 'Dymatize ISO100 er et hydrolysert whey isolate med 25 g protein per 32 g dose og laktose skilt ut ifølge produsent. Sterk DIAAS-estimat, men høy pris per kg og lavere protein% på etikett enn mange ren isolates.',
    strengths: ['Hydrolysert for rask absorpsjon', 'Laktosefattig (laktose skilt ut)', 'Svært lavt fett og karbohydrater'],
    watchouts: ['Dyr (899 kr for 932 g)', 'Melkeallergen — ikke egnet ved melkeallergi', 'Leucin ikke oppgitt på NO-etikett'],
