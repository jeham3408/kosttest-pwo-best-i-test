...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: 'To av de beste PWO-ene i Norge. Peveo Maxed (89p) har 10g L-citrulline, SickPump (80p) har arginin og lavere koffein. Les vår samanlikning.',
  ...
  },
  {
    ...
    content: [
      ...
      'Peveo PWO-Stim-free: 10 000 mg L-citrulline (ren), 5000 mg betain, 3000 mg taurin, 3000 mg tyrosin. Tradisjonell pump via L-citrulline med topp score.',
      ...
      'Vår vurdering: Peveo vinner totalt med høyere score og ren L-citrulline. Midnight Pump har høyere beta-alanin og rødbetebasert pump — et godt alternativ om du vil ha mer beta-alanin uten citrulline.',
    ],
  },
  {
    ...
    excerpt: 'BSN N.O.-Xplode (91p) mot SickPump VeinBlaster (80p). Klassikeren mot pump-spesialisten.',
    category: 'Samanlikning',
    readMinutes: 4,
    relatedProducts: ['nutritac-sickpump', 'bsn-noxplode-50'],
    content: [
      'BSN N.O.-Xplode (91 poeng) og NutriTac SickPump VeinBlaster (80 poeng) er begge populære, men med ulike styrker.',
      'N.O.-Xplode (679 kr, 50 porsjoner): 6000 mg L-citrulline, 3200 mg beta-alanin, 200 mg koffein. Klassisk formel med rhodiola rosea og piperin. Lavest pris per porsjon (13,58 kr).',
      'SickPump (599 kr): 9000 mg L-citrulline, 6000 mg arginin, 200 mg koffein (dobbel dose). Ekstrem pump via kombinasjon av citrulline og arginin, men høy porsjonspris (51,33 kr).',
      'Vår vurdering: N.O.-Xplode vinner på totalscore og pris per porsjon. SickPump har høyere citrulline og arginin per dose — et valg om du prioriterer maksimal pump over pris.',
    ],
  },
  {
    ...
    excerpt: 'Optimum Nutrition Gold Standard (72p) mot Star Nutrition Supreme (82p). Supreme har dobbel dose av nøkkelingrediensene.',
    category: 'Samanlikning',
    readMinutes: 4,
    relatedProducts: ['gold-standard', 'star-supreme'],
    content: [
      'Optimum Nutrition Gold Standard (72 poeng) og Star Nutrition Supreme (82 poeng) er begge premium-produkter fra kjente merker.',
      ...
      'Vår vurdering: Supreme vinner med dobbel L-citrulline og beta-alanin. Gold Standard scorer fortsatt B, men dosene er for lave til å konkurrere med toppproduktene.',
    ],
  },
]
