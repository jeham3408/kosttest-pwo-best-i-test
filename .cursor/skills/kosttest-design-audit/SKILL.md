...
- `design-audit.md` – siste fullstendige audit-dato, antall sider, gjentatte funn.
- Noter hvilke sidetyper som er fikset og hva som gjenstår.

Oppdater minnet etter hver kjøring.
