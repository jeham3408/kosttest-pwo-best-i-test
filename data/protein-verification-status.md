...
| Siste kjøring | 2026-06-26 15:49 |
| Cron | `*/5 * * * *` (hvert 5. min) |
...
- **Fant produktet:** ja (gammel URL ga 404)
- **Endringer:** Feil URL, pakke (907→932 g), pris (699→899 kr), protein% (86→78), dose (31→32 g), ekte produktbilde
- **Laktose:** Filtrert bort ifølge produsent — svært laktosefattig. Allergener: melk, soya.
- **Score:** 66 poeng (A) — DIAAS-estimat 109, pris/g protein høyere etter korreksjon
- **Rapport:** `data/protein-verifications/dymatize-iso100.json`
- **➡️ Neste run:** Test `optimum-gold-standard` — IKKE `dymatize-iso100` igjen.
