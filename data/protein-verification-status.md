...
| Siste kjøring | 2026-06-26 15:44 |
| Cron | `*/5 * * * *` (hvert 5. min) |
...
- **Endringer:** Feil URL, pris (699→899 kr), pakke (907→932 g), dose (31→32 g), protein% (86→78), leucin fjernet (ikke på etikett), ekte produktbilde
- **Laktose:** Skilt ut ifølge produsent — laktosefattig, men inneholder melk og soya
- **Score:** hydrolyzed-whey DIAAS-estimat + høy pris/g protein
- **Rapport:** `data/protein-verifications/dymatize-iso100.json`
- **Neste:** `optimum-gold-standard`
