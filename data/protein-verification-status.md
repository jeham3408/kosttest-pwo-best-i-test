...
|-----------|-------|------|--------|----------|
| `star-whey-100` | Star Nutrition | Whey-100 Myseprotein | 2026-06-26 16:25 | ✅ verified |
...
| Siste kjøring | 2026-06-26 16:25 |
| Cron | `*/5 * * * *` (hvert 5. min) |
...
| 4 | star-whey-100 ← forrige | Star Nutrition | Whey-100 Myseprotein | ✅ verified | 2026-06-26 |
...
- **Fant produktet:** ja (repo-URL var 404 — riktig produkt er Whey-100 Myseprotein, ikke «100% Whey»)
- **Endringer:** Feil URL (404), navn, pris (399→549 kr), porsjon (30→37 g), porsjoner (33→27), protein% (78→84), protein/dose (23→31 g), proteintype (concentrate→isolate), leucin fjernet
- **Laktose:** Lavt innhold (whey isolate) — ikke helt laktosefritt; inneholder melkeallergen. Aspartam i smaksvarianter.
- **Bilde:** `public/images/protein/star-whey-100.jpg` (fra GG)
- **Score:** beregnes på nytt (høyere protein% + isolate, men høyere pris)
