...
|-----------|-------|------|--------|----------|
| `star-whey-100` | Star Nutrition | Whey-100 | 2026-06-26 16:53 | ✅ verified |
...
| Siste kjøring | 2026-06-26 16:53 |
| Cron | `*/5 * * * *` (hvert 5. min) |
...
- **Endringer:** Feil URL (404), navn (100% Whey→Whey-100), type (concentrate→isolate), pris (399→549 kr), porsjon (30→37 g), porsjoner (33→27), protein% (78→84), protein/porsjon (23→31 g), leucin fjernet
- **Laktose:** Lavt innhold (isolat), men IKKE laktosefritt — melkeallergen
- **Andre:** Aspartam i smaksvarianter, soya (lecitin), nøttfri
