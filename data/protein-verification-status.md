...
|-----------|-------|------|--------|----------|
| `star-whey-100` | Star Nutrition | Whey-100 | 2026-06-26 16:21 | ✅ verified |
...
| Siste kjøring | 2026-06-26 16:21 |
| Cron | `*/5 * * * *` (hvert 5. min) |
...
- **Endringer:** Feil URL (404), navn (100% Whey → Whey-100), pris (399→549 kr), type (concentrate→isolate), porsjon (30→37 g), porsjoner (33→27), protein% (78→84), protein/dose (23→31 g), leucin fjernet
- **Laktose:** Lavt innhold (whey isolate) — ikke helt laktosefritt, inneholder melkeallergen
- **Bilde:** `public/images/protein/star-whey-100.jpg` (fra GG)
- **Score:** beregnes på nytt (høyere protein% + høyere pris + bedre DIAAS-estimat som isolate)
