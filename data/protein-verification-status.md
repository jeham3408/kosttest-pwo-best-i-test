...
|-----------|-------|------|--------|----------|
| `star-whey-100` | Star Nutrition | Whey-100 | 2026-06-26 15:59 | ✅ verified |
...
| Siste kjøring | 2026-06-26 15:59 |
| Cron | `*/5 * * * *` (hvert 5. min) |
...
- **Laktose:** Lav laktose (whey isolate) — ikke helt laktosefritt, allergideklarasjon lister laktose
