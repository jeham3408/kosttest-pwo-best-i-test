...
|-----------|-------|------|--------|----------|
| `star-whey-100` | Star Nutrition | Whey-100 | 2026-06-26 16:01 | ✅ verified |
...
| Siste kjøring | 2026-06-26 16:01 |
| Cron | `*/5 * * * *` (hvert 5. min) |
...
- **Fant produktet:** ja (repo-URL ga 404 — riktig produkt er Whey-100 Myseproteinisolat)
- **Endringer:** Feil URL (404), pris (399→549 kr), type (concentrate→isolate), protein% (78→84), porsjon (30→37 g), porsjoner (33→27), leucin fjernet
- **Laktose:** Lavt innhold (isolate), men ikke laktosefritt — uegnet ved alvorlig intoleranse. Melke- og soyaallergen.
- **Bilde:** `public/images/protein/star-whey-100.jpg` (fra GG)
- **Score:** beregnes på nytt (høyere pris, men bedre protein% og isolate-DIAAS)
