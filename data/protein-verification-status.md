...
|-----------|-------|------|--------|----------|
| `star-whey-100` | Star Nutrition | Whey-100 | 2026-06-26 17:09 | ✅ verified |
...
| Siste kjøring | 2026-06-26 17:09 |
| Cron | `*/5 * * * *` (hvert 5. min) |
...
- **Fant produktet:** ja (feil URL i repo var 404 — faktisk produkt er Whey-100, ikke «100% Whey»)
...
- **Laktose:** Lavt innhold (whey isolate) — ikke helt laktosefritt; melk/laktose/soya-allergener
