...
|-----------|-------|------|--------|----------|
| `star-whey-100` | Star Nutrition | Whey-100 Myseprotein | 2026-06-26 16:17 | ✅ verified |
...
| Siste kjøring | 2026-06-26 16:17 |
| Cron | `*/5 * * * *` (hvert 5. min) |
...
- **Fant produktet:** ja (gammel URL 404 — faktisk produkt er Whey-100, ikke «100% Whey»)
- **Endringer:** Feil URL (404), navn, pris (399→549 kr), kildetype (concentrate→isolate), protein% (78→84), porsjon (30→37 g), porsjoner (33→27), protein/dose (23→31 g), leucin fjernet
- **Laktose:** Lavt laktoseinnhold (whey isolate), men ikke laktosefritt — uegnet ved alvorlig intoleranse. Allergener: melk, laktose, soya, fenylalanin
