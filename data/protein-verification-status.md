...
|-----------|-------|------|--------|----------|
| `star-whey-100` | Star Nutrition | Whey-100 | 2026-06-26 16:58 | ✅ verified |
...
| Siste kjøring | 2026-06-26 16:58 |
| Cron | `*/5 * * * *` (hvert 5. min) |
...
- **Fant produktet:** ja
- **Endringer:** Feil URL (404), navn (100% Whey→Whey-100), pris (399→549 kr), type (concentrate→isolate), protein% (78→84), porsjon (30→37 g), protein/dose (23→31 g), leucin fjernet
- **Laktose:** Lavt innhold (whey isolate), men inneholder laktose ifølge allergiinfo — ikke laktosefri
