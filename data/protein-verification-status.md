...
| `bodylab-whey-100` | Bodylab | Whey 100 | 2026-06-26 18:09 | ✅ ferdig (har bilde) |
...
| Siste kjøring | 2026-06-26 18:09 |
...
- **Fant produktet:** ja
- **Endringer:** Pris (349→369 kr listepris), produktbilde hentet, laktose/allergener analysert og lagt til i verdict/watchouts
- **Laktose:** Inneholder laktose fra whey concentrate — IKKE laktosefri. Melke- og soyaallergen (lecitin). Whey-blend (isolat + konsentrat).
- **Bilde:** `public/images/protein/bodylab-whey-100.jpg` (fra bodylab.no CDN)
- **Score:** beregnes på nytt (pris 369 kr, 70 g protein/100 g)
