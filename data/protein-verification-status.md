...
| `bodylab-whey-100` | Bodylab | Whey 100 | 2026-06-26 18:21 | ✅ ferdig (har bilde) |
...
| Siste kjøring | 2026-06-26 18:21 |
...
- **Kilde:** https://www.bodylab.no/whey-100-1-kg
- **Fant produktet:** ja (gammel /shop/-URL redirecter til kanonisk side)
- **Endringer:** URL oppdatert, pris (349→369 kr ordinær, kampanje 297 kr), produktbilde lastet ned, laktoseanalyse lagt til, verdict/watchouts oppdatert
- **Laktose:** Inneholder laktose fra whey concentrate — 8 g karbohydrater / 3,9 g sukkerarter per 100 g. Ikke laktosefri. Melke- og soyaallergen + fenylalanin.
- **Bilde:** `public/images/protein/bodylab-whey-100.jpg` (fra bodylab.no)
- **Score:** beregnes på nytt (høyere ordinærpris, whey-blend DIAAS-estimat)
- **Rapport:** `data/protein-verifications/bodylab-whey-100.json`
- **➡️ Neste:** `myprotein-impact-whey` — IKKE test `bodylab-whey-100` igjen
