...
|-----------|-------|------|--------|----------|
| `star-whey-100` | Star Nutrition | Whey-100 | 2026-06-26 16:33 | ✅ verified |
...
| Siste kjøring | 2026-06-26 16:33 |
| Cron | `*/5 * * * *` (hvert 5. min) |
...
- **Endringer:** Feil URL (404), navn (100% Whey→Whey-100), pris (399→549 kr), porsjon (30→37 g), protein% (78→84), type (concentrate→isolate), leucin fjernet
- **Laktose:** Svært lavt laktoseinnhold (whey isolate), men ikke helt laktosefri — melke- og soyaallergen
