...
|-----------|-------|------|--------|----------|
| `star-whey-100` | Star Nutrition | Whey-100 | 2026-06-26 16:45 | ✅ verified |
...
| Siste kjøring | 2026-06-26 16:45 |
| Cron | `*/5 * * * *` (hvert 5. min) |
...
- **Kilde:** https://www.gymgrossisten.no/whey-100-1-kg-cookies-and-cream/5791.html
- **Fant produktet:** ja (URL i repo var 404 — faktisk produkt er Whey-100, ikke «100% Whey»)
- **Endringer:** Feil URL (404), navn, type (concentrate→isolate), pris (399→549 kr), porsjon (30→37 g), porsjoner (33→27), protein% (78→84), protein/dose (23→31 g), leucin fjernet
- **Laktose:** Lavt laktoseinnhold (whey isolate) — ikke laktosefri, melkeallergen
- **Bilde:** `public/images/protein/star-whey-100.jpg`
- **Score:** beregnes på nytt (høyere protein% + isolate DIAAS, men høyere pris)
