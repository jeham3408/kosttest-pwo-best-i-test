...
| Siste kjøring | 2026-06-26 15:47 |
| Cron | `*/5 * * * *` (hvert 5. min) |
...
- **Fant produktet:** ja (opprinnelig URL var 404)
- **Endringer:** Feil URL, pakke (907g → 932g), pris (699 → 899 kr), protein% (86 → 78), dose (31g → 32g). Produktbilde lagt til.
- **Laktose:** Skilt ut ifølge produsent — laktosefattig, men inneholder melk og soya
- **Score:** 66 (A) — rang #26 etter prisfix og lavere protein%
