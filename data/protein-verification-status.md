...
|-----------|-------|------|--------|----------|
| `star-whey-100` | Star Nutrition | Whey-100 | 2026-06-26 17:21 | ✅ verified |
...
| Siste kjøring | 2026-06-26 17:21 |
| Cron | `*/5 * * * *` (hvert 5. min) |
...
- **Fant produktet:** ja (opprinnelig URL 404 — produktet heter Whey-100, ikke «100% Whey»)
- **Endringer:** Feil URL, navn, type (concentrate→isolate), pris (399→549 kr), porsjon (30→37 g), porsjoner (33→27), protein% (78→84), protein/porsjon (23→31 g), leucin fjernet
- **Laktose:** Lavt innhold (isolat), men inneholder laktose — IKKE laktosefri. Aspartam i de fleste smaker.
- **Bilde:** `public/images/protein/star-whey-100.jpg` (fra GG)
- **Score:** beregnes på nytt (høyere protein% + høyere pris + isolate-DIAAS)
