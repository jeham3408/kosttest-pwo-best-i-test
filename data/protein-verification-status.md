...
|-----------|-------|------|--------|----------|
| `star-whey-100` | Star Nutrition | Whey-100 Myseprotein | 2026-06-26 17:16 | ✅ verified |
...
| Siste kjøring | 2026-06-26 17:16 |
| Cron | `*/5 * * * *` (hvert 5. min) |
...
- **Fant produktet:** ja (på lager)
- **Endringer:** Feil URL (404), navn (100% Whey→Whey-100), pris (399→549 kr), porsjon (30→37 g), porsjoner (33→27), protein% (78→84), protein/dose (23→31 g), kildetype (concentrate→isolate), leucin fjernet
- **Laktose:** Lavt innhold (whey isolate) — ikke helt laktosefritt. Melke- og soyaallergen. Nøttefri.
- **Bilde:** `public/images/protein/star-whey-100.jpg` (fra GG)
- **Score:** 86 (A) — DIAAS-estimat 1.09, 0,65 kr/g protein
