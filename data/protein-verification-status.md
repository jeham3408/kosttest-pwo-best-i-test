...
|-----------|-------|------|--------|----------|
| `star-whey-100` | Star Nutrition | Whey-100 | 2026-06-26 16:13 | ✅ verified |
...
| Siste kjøring | 2026-06-26 16:13 |
| Cron | `*/5 * * * *` (hvert 5. min) |
...
- **Fant produktet:** ja (Whey-100, ikke «100% Whey» — gammel URL ga 404)
- **Endringer:** Feil URL (404), navn (100% Whey → Whey-100), pris (399→549 kr), porsjon (30→37 g), porsjoner (33→27), protein% (78→84), protein/dose (23→31 g), sourceType (concentrate→isolate), leucin fjernet
- **Laktose:** Lavt laktoseinnhold (whey isolate), men inneholder laktose — ikke laktosefritt. Produsent advarer mot alvorlig laktoseintoleranse
