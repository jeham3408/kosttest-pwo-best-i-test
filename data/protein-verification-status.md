...
|-----------|-------|------|--------|----------|
| `star-whey-100` | Star Nutrition | Whey-100 | 2026-06-26 16:09 | ✅ verified |
...
| Siste kjøring | 2026-06-26 16:09 |
| Cron | `*/5 * * * *` (hvert 5. min) |
...
- **Laktose:** Lavt innhold (whey isolate) — ikke laktosefritt. Inneholder melk, laktose, soya, fenylalanin. Nøttefri.
